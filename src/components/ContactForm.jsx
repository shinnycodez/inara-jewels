...
#fefaf9] p-8 rounded-2xl shadow-lg border border-pink-300">
      <h2 className="text-2xl font-bold text-[#760AB0] mb-4 text-center"> Leave a comment</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          className="w-full bg-[#760AB0] hover:bg-pink-600 text-white font-semibold py-2 px-4 rounded-lg transition duration-300"
        >
          ✨ Send
        </button>
      </form>
